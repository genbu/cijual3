...
--
-- Struktur dari tabel `tbl_pengeluaran_detail`
--
...
--
-- Dumping data untuk tabel `tbl_pengeluaran_detail`
--

INSERT INTO `tbl_pengeluaran_detail` (`kd_pengeluaran`, `kd_barang`, `qty`) VALUES
('O-001', 'B-001', 2),
('O-001', 'B-002', 3);
...
--
-- Struktur dari tabel `tbl_pengeluaran_header`
--
...
--
-- Dumping data untuk tabel `tbl_pengeluaran_header`
--

INSERT INTO `tbl_pengeluaran_header` (`kd_pengeluaran`, `kd_pelanggan`, `total_harga`, `tanggal_pengeluaran`, `kd_pegawai`) VALUES
