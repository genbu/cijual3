    ...
    <form class="form-horizontal" method="post" action="<?php echo site_url('master/tambah_barang')?>">
        <div class="modal-body">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="min_stok" type="text" placeholder="Input Minimum Stok...">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="satuan" type="text" placeholder="Input satuan barang...">
                </div>
            </div>
            ...
            <form class="form-horizontal" method="post" action="<?php echo site_url('master/edit_barang')?>">
                <div class="modal-body">
                    ...
                    <div class="control-group">
                        <label class="control-label" >Minimum Stok</label>
                        <div class="controls">
                            <input name="min_stok" type="text" value="<?php echo $row->min_stok;?>">
                        </div>
                    </div>
