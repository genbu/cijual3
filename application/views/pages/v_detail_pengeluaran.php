...
<div class="container">
    ...
    <div class="well">
        ...
        <div class="row-fluid">
            <?php if(isset($dt_pengeluaran)){
                foreach($dt_pengeluaran as $row){
                    ?>
                    <div class="span6">
                        <dl class="dl-horizontal">
                            <dt>Kode pengeluaran :</dt>
                            <dd><?php echo $row->kd_pengeluaran?></dd>
                            <br/>
                            <dt>Tanggal pengeluaran :</dt>
                            <dd><?php echo date("d M Y",strtotime($row->tanggal_pengeluaran));?></dd>
                            <br/>
                            <dt>Total Harga :</dt>
    ...
    <div class="well">
        ...
        <div class="row-fluid">
            ...
            <div class="form-actions">
                <a href="<?php echo site_url('pengeluaran')?>" class="btn btn-inverse">
