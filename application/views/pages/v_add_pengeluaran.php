...
<div class="well">
    <form>
        ...
        <div class="controls">
            <input type="text" class="input-xlarge" value="<?php echo $kd_pengeluaran; ?>" readonly>
        </div>
    ...
    <form action="<?php echo site_url('pengeluaran/simpan_pengeluaran') ?>" method="post">
        <div class="row-fluid">
            <div class="span8">
            ...
            <div class="span4 badge pull-right">
                ...
                <input type="hidden" name="kd_pengeluaran" value="<?= $kd_pengeluaran; ?>" readonly>
...
<!-- ============ MODAL ADD pengeluaran BARANG =============== -->
<div id="modalAddpengeluaranBarang" class="modal hide fade">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h3 id="myModalLabel">Tambah Barang</h3>
    </div>
    <form id="frm" name="frm"  method="post" action="<?php echo site_url('pengeluaran/tambah_pengeluaran_to_cart')?>">
